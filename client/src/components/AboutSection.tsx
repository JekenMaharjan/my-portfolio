...
const AboutSection = () => {
    ...
    return (
        <section id="about" className="py-16 sm:py-20 px-6 bg-gray-900 text-white">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        {highlights.map((item, index) => (
                            <Card
                                key={index}
                                className="group bg-gray-800 hover:shadow-card transition-all duration-300 border border-border/50"
                            >
                                <CardContent className="p-6">
                                    <div className="flex flex-col items-center text-center space-y-3">
                                        ...
                                        <h4 className="font-semibold text-white text-base sm:text-lg">{item.title}</h4>
